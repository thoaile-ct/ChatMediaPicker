...
import com.zhihu.matisse.internal.ui.widget.MarkView;
...
public class AlbumMediaAdapter extends
    ...
    @Override
    public void onCheckViewClicked(MarkView markView, Item item, RecyclerView.ViewHolder holder) {
        updateSelectedItem(item, holder);
    }

    private void updateSelectedItem(Item item, RecyclerView.ViewHolder holder) {
        if (mSelectionSpec.countable) {
          MarkView markView =  holder.itemView.findViewById(R.id.markView);
