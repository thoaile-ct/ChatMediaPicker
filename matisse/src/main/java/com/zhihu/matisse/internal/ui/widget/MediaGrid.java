...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (mListener != null) {
           /* if (v == mThumbnail) {
                ...
                mListener.onCheckViewClicked(markView, mMedia, mPreBindInfo.mViewHolder);
            }*/
    ...
    public void setCheckEnabled(boolean enabled) {
        markView.setEnabled(enabled);
    }

    public void setCheckedNum(int checkedNum) {
        markView.setCountNumber(checkedNum);
    }

    public void setChecked(boolean checked) {
        Log.e("NoOne", "checked: " + checked);
    ...
    public interface OnMediaGridClickListener {
        ...
        void onCheckViewClicked(MarkView markView, Item item, RecyclerView.ViewHolder holder);
    }
